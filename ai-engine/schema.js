...
const RECOVERY_ANALYSIS_SCHEMA = {
  ...
  properties: {
    ...
    suggested_response: {
      type: 'STRING',
      description: 'A complete customer-facing recovery message that the agent can send directly. Respect the customer preferred language and communication tone. Keep it professional, concise, polite, and focused on payment recovery.'
    }
  },
